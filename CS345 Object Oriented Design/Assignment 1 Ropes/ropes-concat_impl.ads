...
private package Ropes.Concat_Impl is
	...
	--------------------------------------------------------------
	-- My additions for Part 2, step 3
	--------------------------------------------------------------
	
	-- Instantiation of the abstract methods defined in ropes.ads from Part 2, step 1
	function "&" (Left	: access Concat_Impl; 
				  Right : String) 
		return Rope_Impl_Access;
		
	function "&" (Left  : String; 
				  Right : access Concat_Impl) 
		return Rope_Impl_Access;
	--------------------------------------------------------------
	--------------------------------------------------------------
