...
void smooth(int dim, pixel *src, pixel *dst) 
{
	...
	// This section will tell how many times I can iterate through with a full 32 column chunk before having to do a 31 column block
	int times_to_iterate = 0;
	int dim_copy = dim;
	while (dim_copy > 0) {
		times_to_iterate += 1;
		dim_copy -= 32;
