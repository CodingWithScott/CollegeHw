...
package body book_pack is
	...
	begin
--		put_line("Entered book_pack.Change_Stock");
--		put("Book.stock = "); put(book.stock); new_line;
--		put("Change = "); put(change); new_line;
--		put("Book.stock + change = "); put(book.stock + change); new_line;
