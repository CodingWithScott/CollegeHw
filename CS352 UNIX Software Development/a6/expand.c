/*	$Id: expand.c,v 1.35 2014/12/05 04:18:58 felchs Exp $	*/
...
int expand(char *line, char *expline, int newsize) {
	...
	/* Kill any zombies that might have been generated from $() expansions */ 
	kill_zombies();
...
int exp_paran (char *line, char *expline, int *r_ix, int *w_ix) {
	...
	cpid = processline(&line[cmd], 
					   pipefd[0], 
					   pipefd[1], 
					   STDERR, 
					   NO_WAIT_THX | EXPAND_PLS); 
