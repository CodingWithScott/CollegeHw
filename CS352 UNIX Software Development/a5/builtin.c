/*	$Id: builtin.c,v 1.20 2014/11/12 23:33:49 felchs Exp $	*/
...
void read_name 	(char **argv, int argc);
...
int exec_builtin(char **argv, int argc, int outfd) {
...
void read_name (char **argv, int argc) {
	...
	if (setenv(name, value, 1)) {
		fprintf (stderr, "read_name():\tsetenv error\n");
		last_exit_val = 1;
	}
