...
package body Heap_Pack is
		...
		function Larger_Child (Heap: heap_pack_array;
		...
		procedure Reheap_Down (Heap : in out heap_pack_array) is
		...
		-- place, restore the heap property:  not (Heap(Child) > Heap(Parent))
		procedure Reheap_Up (Heap : in out heap_pack_array) is
		...
		procedure Heapify (Heap: in out heap_pack_array) is
